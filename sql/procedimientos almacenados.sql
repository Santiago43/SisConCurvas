...
insert into Usuario (Rol_ID, Persona_ID,Contraseña,Url_imagen,Tipo_documento,Documento,estado) values (_Rol_ID, (select Persona_ID from Persona order by Persona_ID desc limit 1),sha(_Contraseña),_Url_imagen,_Tipo_documento,_Documento,true);
end $$
